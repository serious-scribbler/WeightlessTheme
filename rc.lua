...
--      And your device features with xinput list-props <id>
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local tagnames = { "Home", "Coding", "Web", "Tiling", "Floating"}
    local lf = awful.layout.suit.floating
    local lt = awful.layout.suit.tile
    local layouts = {lt, lt, awful.layout.suit.max, lt, lf}
